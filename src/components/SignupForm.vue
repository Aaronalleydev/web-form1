<template>
<!-- I need to work out the enter on the skills to not submit the form -->
  <form @submit.prevent="handleSubmit">
      ...
      <label>Role:</label>
      <select v-model="role">
          <option value="develeper">Web develeper</option>
      ...
      <div>
          <input type="checkbox" value="aaron" v-model="names">
          <label>Aaron</label>
      </div> -->
...
export default {
    ...
    methods: {
        addSkill(e) {
            if (e.code === 'Enter' && this.tempSkill) {
